    ...
    for nb_iter in range(start_iter, args.total_iter):
        ...
        for micro_step in range(accum_steps):
            ...
            if args.use_masking:
                ...
                #! testing with mix masking instead of no mask
                modes = ["random", "block", "span"]
                mode = modes[nb_iter % 3]
                mask_ratios = {
                    "random": getattr(args, "r_rand", 0.6),
                    "block": getattr(args, "r_block", 0.6),
                    "span": getattr(args, "r_span", 0.4),
                }
                ...
                loss, loss_ctc, loss_sgm = compute_losses(
                    ...
                    mask_mode=mode,
                    mask_ratio=mask_ratio,
                    block_span=getattr(args, "block_span", 4),
                    max_span_length=getattr(args, "max_span", 8),
                    use_masking=True
                )
